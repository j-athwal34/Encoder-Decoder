...
win=Tk()
win.resizable(0,0)
win.geometry("800x500") #change the side frame and the main frame sizes if this is changed
...
#side frame setup
sideframe=Frame(win, bg=sideframe_bgc, width=250, relief=FLAT, highlightthickness=2, highlightbackground="black")
sideframe.pack(side=LEFT, fill=Y)

#sideframe widgets
logo = Label(sideframe, bg=sideframe_bgc, text="Encrypt/Decrypt Tool", font=("Arial", 18))
...
button1 = Button(sideframe, text=eT, font=("Arial", 14), bg=button_bg, fg=button_fg, cursor="", width=150, pady=10, command=lambda m=eT: change_view(m))
button1.pack(pady=15)

button2 = Button(sideframe, text=eF, font=("Arial", 14), bg=button_bg, fg=button_fg, cursor="", width=150, pady=10, command=lambda m=eF: change_view(m))
button2.pack(pady=15)

button3 = Button(sideframe, text=dT, font=("Arial", 14), bg=button_bg, fg=button_fg, cursor="", width=150, pady=10, command=lambda m=dT: change_view(m))
button3.pack(pady=15)

button4 = Button(sideframe, text=dF, font=("Arial", 14), bg=button_bg, fg=button_fg, cursor="", width=150, pady=10, command=lambda m=dF: change_view(m))
button4.pack(pady=15)

quitButton = Button(sideframe, text="Quit", font=("Arial", 14), bg="#FF0000", fg=button_fg, cursor="", width=150, pady=10, command=closeAPP)
...
#main frame setup
mainframe = Frame(win, bg=mainframe_bgc, width=550, relief=FLAT, highlightthickness=1, highlightbackground="black")
mainframe.pack(expand=True, fill=BOTH)

#mainframe widgets
initialLabel = Label(mainframe, bg="white", text="Choose an option.", font=("Arial", 18))
...
class encryptText:
    def __init__(self):
        ...
        self.text_Enc = Text(self.encTextFrame, bg='white', width=100, height=10, font=("Arial", 16), relief=FLAT, highlightthickness=1, highlightbackground="black")
        ...
        #hidden textbox
        self.encodedLabel = Text(self.encTextFrame, bg=mainframe_bgc, width=100, height=6, font=("Arial", 18), cursor="arrow", relief=FLAT, highlightthickness=1, highlightbackground=mainframe_bgc)
        
        self.encodedLabel.configure(state="disabled")
        
        
        self.submit_text = Button(self.encTextFrame, text='Submit Text', font=('Arial',14), bg=button_bg, fg=button_fg, width=110, height=40, command=self.encTextController)
        
        self.submit_text.bind("<Enter>", self.on_enterEncText)
        self.submit_text.bind("<Leave>", self.on_leaveEncText)
        
        self.clear_text = Button(self.encTextFrame, text='Clear Input Box', font=('Arial',14), bg=button_bg, fg=button_fg, width=110, height=40, command=self.clearTextCommand)
    ...
    def start(self):
        ...
        self.encTextFrame.pack(expand=True, fill=BOTH)
        self.text_Enc.pack(side=TOP, padx=20, pady=20)
        self.encodedLabel.pack(side=BOTTOM, padx=20, pady=20)
        self.submit_text.pack(side=RIGHT, padx=20) #no pady because text_Enc has it
        self.clear_text.pack(side=LEFT, padx=20) #no pady because text_Enc has it
...
class decryptText:
    def __init__(self):
        ...
        self.text_Dec = Text(self.decTextFrame, bg='white', width=100, height=10, font=("Arial", 16), relief=FLAT, highlightthickness=1, highlightbackground="black")
        ...
        #hidden textbox
        self.decodedLabel = Text(self.decTextFrame, bg=mainframe_bgc, width=100, height=6, font=("Arial", 18), cursor="arrow", relief=FLAT, highlightthickness=1, highlightbackground=mainframe_bgc)
        
        self.decodedLabel.configure(state="disabled")
        
        
        self.submit_text = Button(self.decTextFrame, text='Submit Text', font=('Arial',14), bg=button_bg, fg=button_fg, width=110, height=40, command=self.encTextController)
        
        self.submit_text.bind("<Enter>", self.on_enterEncText)
        self.submit_text.bind("<Leave>", self.on_leaveEncText)
        
        self.clear_text = Button(self.decTextFrame, text='Clear Input Box', font=('Arial',14), bg=button_bg, fg=button_fg, width=110, height=40, command=self.clearTextCommand)
        self.clear_text.bind("<Enter>", self.on_enterEncTextClear)
        self.clear_text.bind("<Leave>", self.on_leaveEncTextClear)
    ...
    def start(self):
        ...
        self.decTextFrame.pack(expand=True, fill=BOTH)
        self.text_Dec.pack(side=TOP, padx=20, pady=20)
        self.decodedLabel.pack(side=BOTTOM, padx=20, pady=20)
        self.submit_text.pack(side=RIGHT, padx=20) #no pady because text_Enc has it
        self.clear_text.pack(side=LEFT, padx=20) #no pady because text_Enc has it
...
class encryptFile:
    def __init__(self):
        ...
        self.chooseFileButton = Button(self.frame, text='Choose .txt File', font=('Arial',14), bg=button_bg, fg=button_fg, width=110, height=40, command=self.chooseFile)
        
        
        self.chooseFileButton.bind("<Enter>", self.on_enterFile)
        self.chooseFileButton.bind("<Leave>", self.on_leaveFile)
        
        self.fileDirectory = Text(self.frame, bg=mainframe_bgc, width=100, height=1, cursor='arrow', font=("Arial", 18), relief=FLAT, highlightthickness=1, highlightbackground=mainframe_bgc)
        self.fileDirectory.configure(state='disabled')

        

        self.saveDirectory = Text(self.frame, bg=mainframe_bgc, width=100, height=1, cursor='arrow', font=("Arial", 18), relief=FLAT, highlightthickness=1, highlightbackground=mainframe_bgc)
    ...
    def createSaveButton(self):
        if self.savebuttoncreated == False:
            ...
            self.saveAsButton = Button(self.frame, text='Save encrypted file (.txt)', font=('Arial',14), bg=button_bg, fg=button_fg, width=190, height=40, command=self.saveNewFile)
    ...
    def saveNewFile(self):
        ...
        if self.finished == False:
            self.showLabel = Label(self.frame, text=self.label, font=("Arial", 18))
